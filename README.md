...
Я использовал DataTable и SweetAlert

DataTable используется для красивого и удобного отображения таблицы и ее элементов, включает в себя пагинацию, сортировку по атрибутам, поиск и фильтрацию

SweetAlert используется для отображения модального окна сущности при клике на строку таблицы
